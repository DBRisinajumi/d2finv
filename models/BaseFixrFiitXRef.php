...
abstract class BaseFixrFiitXRef extends CActiveRecord
{
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'fixr_frep_id' => Yii::t('D2finvModule.model', 'Fixr Frep'),
            'fixr_fcrn_date' => Yii::t('D2finvModule.model', 'Fixr Fcrn Date'),
            'fixr_fcrn_id' => Yii::t('D2finvModule.model', 'Fixr Fcrn'),
            'fixr_amt' => Yii::t('D2finvModule.model', 'Fixr Amt'),
            'fixr_base_fcrn_id' => Yii::t('D2finvModule.model', 'Fixr Base Fcrn'),
