...
class m140602_151501_create_table_finv_invoice extends CDbMigration
{
	...
	public function up()
	{
		$this->execute("
            CREATE TABLE IF NOT EXISTS `finv_invoice` (
              `finv_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
              `finv_series_number` varchar(10) DEFAULT NULL,
              `finv_number` varchar(20) NOT NULL,
              `finv_sys_ccmp_id` int(10) unsigned NOT NULL,
              `finv_ccmp_id` int(10) unsigned NOT NULL,
              ...
              `finv_notes` text,
              `finv_fcrn_id` tinyint(3) unsigned NOT NULL,
              ...
              `finv_basic_fcrn_id` tinyint(3) unsigned NOT NULL,
              ...
              `finv_stst_id` tinyint(3) unsigned DEFAULT NULL,
              ...
              `finv_type` enum('in','out') NOT NULL DEFAULT 'out',
              PRIMARY KEY (`finv_id`),
              KEY `finv_fcrn_id` (`finv_fcrn_id`),
              KEY `finv_number` (`finv_number`(4)),
              KEY `finv_basic_fcrn_id` (`finv_basic_fcrn_id`),
              KEY `finv_payer_ccmp_id` (`finv_ccmp_id`),
              KEY `finv_issuer_ccmp_id` (`finv_sys_ccmp_id`),
              KEY `finv_stst_id` (`finv_stst_id`)
            ) ENGINE=InnoDB  DEFAULT CHARSET=utf8;

            ALTER TABLE `finv_invoice`
              ADD CONSTRAINT `finv_invoice_ibfk_1` FOREIGN KEY (`finv_sys_ccmp_id`) REFERENCES `ccmp_company` (`ccmp_id`),
              ADD CONSTRAINT `finv_invoice_ibfk_2` FOREIGN KEY (`finv_ccmp_id`) REFERENCES `ccmp_company` (`ccmp_id`),
