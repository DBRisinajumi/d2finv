    ...
    <div class="widget-box no-padding">
        <div class="widget-header">
            <h4><?= Yii::t('D2finvModule.model', 'Set expenses position') ?></h4>
        </div>
                        ...
                        <div class='controls'>
                                      ...
                                      echo CHtml::dropDownList(
                                              ...
                                              array(
                                                  ...
                                                  'prompt' => Yii::t('D2finvModule.model', 'Select service type'),
                                                  'ajax' => array(
                                                      'type' => 'GET',
...
//                                                'options' => array(
//                                                    'placeholder' => Yii::t('D2finvModule.model', 'Select service type'),
//
