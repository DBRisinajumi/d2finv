        ...
        <div class="span12">
            <div class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('D2finvModule.model', 'tooltip.fixr_id')) != 'tooltip.fixr_id')?$t:'' ?>'>
                                <?php
                            ;
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('D2finvModule.model', 'tooltip.fixr_fiit_id')) != 'tooltip.fixr_fiit_id')?$t:'' ?>'>
                                <?php
                            $this->widget(
                '\GtcRelation',
                array(
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('D2finvModule.model', 'tooltip.fixr_fret_id')) != 'tooltip.fixr_fret_id')?$t:'' ?>'>
                                <?php
                            $this->widget(
                '\GtcRelation',
                array(
                ...
                array(
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('D2finvModule.model', 'tooltip.fixr_base_amt')) != 'tooltip.fixr_base_amt')?$t:'' ?>'>
                                <?php
