...
if(!$ajax || $ajax == 'fiit-invoice-item-grid'){
    Yii::beginProfile('fiit_fprc_id.view.grid');
?>
...
<?php 
    ...
    if (empty($modelMain->fiitInvoiceItems)) {
        ...
        $model->fiit_fprc_id = $modelMain->primaryKey;
        $model->save();
        unset($model);
    } 
            ...
            */
                ...
                array(
                    ...
                    'buttons' => array(
                        ...
                        'delete' => array('visible' => 'Yii::app()->user->checkAccess("D2finv.FprcProductCategory.DeletefiitInvoiceItems")'),
                    ),
