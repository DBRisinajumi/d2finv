...
$demo_path = realpath(Yii::getPathOfAlias('vendor.dbrisinajumi') . '/d2finv/assets');

$jquery_ui_link   = Yii::app()->assetManager->publish($ace_path,  false, -1, false);
$dialog_demo_link = Yii::app()->assetManager->publish($demo_path, false, -1, false);

$cs->registerCssFile($jquery_ui_link      . '/css/jquery-ui-1.10.3.full.min.css');
$cs->registerScriptFile($jquery_ui_link   . '/js/jquery-ui-1.10.3.full.min.js');
$cs->registerScriptFile($dialog_demo_link . '/js/demo.js');
...
<div class="row">
    ...
    <div class="span7">
        <a id="id-btn-dialog1" class="btn btn-purple btn-sm" href="#">Modal Dialog</a>
    </div>
</div>
