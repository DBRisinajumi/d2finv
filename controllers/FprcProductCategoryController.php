...
public function accessRules()
{
     return array(
        array(
            ...
            'roles' => array('D2finv.FprcProductCategory.*'),
        ),
        array(
            'allow',
            'actions' => array('create','ajaxCreate'),
            'roles' => array('D2finv.FprcProductCategory.Create'),
        ),
        array(
            'allow',
            'actions' => array('view', 'admin'), // let the user view the grid
            'roles' => array('D2finv.FprcProductCategory.View'),
        ),
        array(
            'allow',
            'actions' => array('update', 'editableSaver'),
            'roles' => array('D2finv.FprcProductCategory.Update'),
        ),
        array(
            'allow',
            'actions' => array('delete'),
            'roles' => array('D2finv.FprcProductCategory.Delete'),
        ),
        array(
            'deny',
            'users' => array('*'),
    ...
    public function actionView($fprc_id, $ajax = false)
    {
    ...
    public function actionEditableSaver()
    {
        ...
        $es = new TbEditableSaver('FprcProductCategory'); // classname of model to be updated
        $es->update();
    }
